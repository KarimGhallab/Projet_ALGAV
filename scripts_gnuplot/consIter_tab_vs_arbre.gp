...
set output '../graphiques/consIter_tab_vs_arbre.pdf'	

set style data histograms
set boxwidth 0.8
set title "Temps d'exécution de la construction d'un tas : tableau vs arbre"
...
plot "../resultats/consIter_tab_vs_arbre.csv"\
