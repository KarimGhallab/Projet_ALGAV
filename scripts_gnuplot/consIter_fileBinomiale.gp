...
set yrange [0 to 615]						# Commence la graduation à 0
...
plot "../resultats/consIter_fileBinomiale.csv" using 2:xtic(1) title "Temps d'exécution moyen" lt rgb "#00B37B",\
     ...
     "" using 0:($2 + 10.0):2 with labels notitle,\
     "" using 0:($3 + 15.0):3 with labels offset 2.7 notitle				# notitle permet de ne pas avoir l'élément présent dans la légende
